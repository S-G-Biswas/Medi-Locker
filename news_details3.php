        ...
        <div class="col-lg-12">
          <article class="blog-details">
            <div class="post-thumb">
              <img src="../assets/img/blog/sugar.png" alt="">
            </div>
          
            <h2 class="post-title h1">What is the impact of eating too much sugar?</h2>
            <div class="post-content">
              <p>When you eat excess sugar, the extra insulin in your bloodstream can affect your arteries all over your body. It causes their walls to get inflamed, grow thicker than normal and more stiff, this stresses your heart and damages it over time. This can lead to heart disease, like heart failure, heart attacks, and strokes.</p>
